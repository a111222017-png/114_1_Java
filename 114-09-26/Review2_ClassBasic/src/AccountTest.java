public class AccountTest {
    public static void main(String[] args) {
        ...
        System.out.printf("帳戶號碼: %s%n存款餘額: %.2f%n", account1.getBalance(), account1.getBalance());

        account1.withdraw(1000.0);
        System.out.printf("帳戶號碼: %s%n提款後餘額: %.2f%n", account1.getBalance(), account1.getBalance());

        // 測試非法存款
        try {
            account1.deposit(-1000.0);
            System.out.printf("帳戶號碼: %s%n存款後餘額: %.2f%n", account1.getBalance(), account1.getBalance());
